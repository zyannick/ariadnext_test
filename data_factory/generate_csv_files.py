...
parser = argparse.ArgumentParser(description="Generating csv file for triplet loss!")
parser.add_argument('--dataroot', '-d', type=str,  default='/home/neil/Workspace/Postdoc/ariadnext_test/Datasets/cropped/lfw_224',
...
parser.add_argument('--csv_name', type=str, default='./data_factory/generated_triplets/lfw_224.csv',
